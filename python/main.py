...
mpc = MPC(A,B,np.diag([15.0, 3.0, 30.0, 4.0]),np.diag([15.0, 3.0, 30.0, 4.0]),np.array([[0.5]]) )
#PID 
#controller = PID([14.5, 50.0],[0.0,2.0],[9.0,9.0])
#
#PID_cartpole = Cartpole(1.5, 0.5, 0.5, controller, noisy=False, theta0=0.25)
...
#
#LQR_cartpole = Cartpole(1.5, 0.5, 0.5, controller, noisy=False ,theta0=0.25)
