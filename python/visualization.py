...
class visualizer:
    ...
    def update(self, x, theta, L):
        if self.running:
            ...
            pygame.draw.circle(self.screen, "red", self.pendulum_pos, 10)
            pygame.draw.line(self.screen, "blue", (self.cart_pos.x + self.cart_width/2, self.cart_pos.y), self.pendulum_pos)
            pygame.display.flip()
